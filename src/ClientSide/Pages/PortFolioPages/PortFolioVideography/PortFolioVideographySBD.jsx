            ...
            md:mt-[-50px] md:rounded-t-[50px]
             ...
             ">
                ...
                text-white">
                    ...
                    <div className="">
                    <h4 className="titleSubHeading pb-[30px]">SBD / Commercial</h4>
                        ...
                        <div className="">
                            ...
                            <div className="w-[100%] xl:h-[500px] 2xl:h-[700px] lg:h-[400px] md:h-[300px] h-[200px]">
                                <iframe title="vimeo-player" src="https://player.vimeo.com/video/930976952?h=17341dd9d0" className="w-full h-full" frameBorder="0" allowfullscreen></iframe>
                            </div>
...
export default PortFolioVideographySBD;